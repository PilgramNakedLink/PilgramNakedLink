...
<body>
   ...
   <script src="https://maps.google.com/maps/api/js?libraries=geometry&sensor=false&key=AIzaSyC0fi7C5rrjmI4BXKy5fSWIs9pxmVF_SHY&API_KEY=AIzaSyC0fi7C5rrjmI4BXKy5fSWIs9pxmVF_SHY"></script>

  <script type="text/javascript">
     var PRINT_INTERVAL = 300 * 60 * 1000;
     ...
     $(function() {
        ...
        pilgram.getLocalLocation((position) => {
            ...
            var handler = setInterval(processTrace, PRINT_INTERVAL);
